...
namespace BaggageTransfer.Performance
{
    public static class ApplicationStateHelper
    {
        ...
        /// <summary>
        /// Update value of the application state using
        /// appropriate name/value pairs
        /// </summary>
        /// <typeparam name="T">Type of application state item</typeparam>
        /// <param name="o">Item to be application state</param>
        ...
        public static void Update<T>(string key, T o)
        {
            ...
            HttpContext.Current.Application.Set(key, o);
        }
        ...
        public static void SetOrUpdate<T>(string key, T value)
        {
            if (Exists(key))
            {
                Update(key, value);
