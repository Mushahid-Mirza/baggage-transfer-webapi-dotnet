...
namespace BaggageTransfer.Util
{
    public static class Extensions
    {
        ...
        public static string Shortify(this string str, int length)
        {
        ...
        public static String ToShortDescription(this String str, int size = 12)
        {
        ...
        public static String ColonNextLine(this String str)
        { 
            return str + " : \n";
        }
    }
