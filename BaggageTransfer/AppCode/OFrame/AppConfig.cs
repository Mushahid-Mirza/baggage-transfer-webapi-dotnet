...
namespace BaggageTransfer
{
    public static class AppConfig
    {
        ...
        public static string SiteAdminName
        {
            get
            {
                return KeywordsHelper.GetKeywordValue("SiteAdminName");
            }

            set
            {
                KeywordsHelper.SetKeywordValue("SiteAdminName", value);
            }
        }
        ...
        public static string CountryCode { get; internal set; }
        ...
        public static string ContentsFile
        {
            get
            {
                return HttpRuntime.AppDomainAppPath + KeywordsHelper.GetKeywordValue("ContentsFile");
            }
        }
        ...
        public static string SendGridAPIKey
        {
            get
            {
                var value = KeywordsHelper.GetKeywordValue("SendGridAPIKey");
            ...
            {
                var sm = new SymCryptography();
                KeywordsHelper.SetKeywordValue("SendGridAPIKey", sm.Encrypt(value));
            }
        }
        ...
        public static string GetContentGraphics(string name, string theme)
        {
            return String.Format(ContentsHelper.GetKeywordValue(name), theme);

        }

        public static string EmailTemplateFile(string name)
        {
            return HttpRuntime.AppDomainAppPath + KeywordsHelper.GetKeywordValue(name);
        }
    }
}
