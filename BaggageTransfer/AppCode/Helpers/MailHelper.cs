...
namespace BaggageTransfer.Helpers
{
    public static class MailHelper
    {
        ...
        //public static void SendUsingSendGrid(EmailMessage message)
        //{
        //    SendGridEmailHelper.SendMail(message);
        //}

        //public static Task SendUsingSendGridAsync(EmailMessage message)
        //{
        //    return SendGridEmailHelper.SendMailAsync(message);
        //}
